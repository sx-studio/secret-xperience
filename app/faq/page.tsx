    ...
    items: [
      {
        ...
        a: `Browse verified provider listings and select a profile that interests you. On the profile page, click "Request Booking" and choose your preferred date, time, and duration. The provider will receive your request and confirm or decline. Once accepted, you complete payment securely through Stripe. You will receive a confirmation email with all details.`,
      },
      {
    ...
    items: [
      {
        ...
        a: `Create an account with your email address and choose a display name. From your provider dashboard, click "Create Listing" and complete your profile — bio, photos, rates, availability, and service areas. Your listing will be held for moderation review and typically approved within 24 hours. You can update your listing at any time.`,
      },
      {
        q: 'How do I get verified?',
        a: `From your provider dashboard, click "Get Verified" and follow the steps. You will be asked to upload a government-issued photo ID and complete a facial liveness check. This process is handled by our trusted third-party verification partner — your documents are not stored on our servers. Verification typically takes 1–2 business days.`,
      },
      {
      ...
      },
      {
        ...
        a: `Payouts are processed via Stripe Connect to your linked bank account. Funds are typically released within 2–5 business days after a booking is marked as completed. You can view your earnings and payout history in your provider dashboard. Minimum payout threshold is €20. Payouts are issued in euros.`,
      },
    ],
  },
  {
    ...
    <div style={{ background: '#080808', minHeight: '100vh', color: '#e8e0d0', fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: '#666', maxWidth: 480, margin: '0 auto', lineHeight: 1.7 }}>
          Answers to the most common questions from clients, providers, and newcomers to the platform.
        </p>
      </div>
